...
<html>
  <head>
    <meta charset="UTF-8">
    <title>EliteLogistics</title>
    <link rel="icon" type="image/png" href="./dist/img/logo.jpg">
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a style="background-color: white;" href="index2.html" class="logo"><img style="width:60%" src="dist/img/logo_ori4.jpg" alt=""></a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="./backend/sign_out.php" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
