...
if ($startDate && $endDate) {
    ...
    $sql = " SELECT * FROM shipments WHERE invoice_date BETWEEN '$startDate' AND '$endDate'";
}
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Reciepts</li>
          </ol>
        </section>
                      ...
                      <tbody>
                          ...
                          <tr id="row-<?= $row['id'] ?>">
                            <td><?= $row['id'] ?></td>
                              ...
                              <td>
                                <a href="./edit_receipt_n.php?reciept_id=<?= $row['id'] ?>" target="_blank" class="btn btn-primary">View & Edit</a>
