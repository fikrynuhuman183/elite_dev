                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="customer" name="customer" required class="form-control">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="salesperson" name="salesperson" required class="form-control">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr class="border-charge-row" data-index="1">
                                                    ...
                                                    <td><input type="text" class="form-control rate-input" id="quantity" name="quantity" placeholder="Enter quantity"></td>
