                  ...
                  <div class="  box-body">
                    <div class="row">
                      <div class=" form-group col-md-10 ">
                        <select value="<?= $row['customer_id'] ?>" onchange="selectConsignee()" id="customer_id" class="form-control">
                        </select>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        $sql2 = "SELECT vat_number FROM customers WHERE customer_id='$customer'";
                        ...
                        ?>
                        <input type="text" value="<?= $vat ?>" name="customerVATnumber" class="form-control" id="customerVATnumber">
                      </div>
                    </div>
...
function generateInvoicePrint(data) {
      ...
      let printContent = `
            ...
            <head>
                <style>
                    ...
                    font-size: 12px; /* Decrease the font size */
                    line-height: 1.2; /* Decrease the line spacing */
                    background-image: url('inv_temp_fin.jpg');
                    background-size: cover; /* This ensures the image covers the whole background */
                    background-position: center; /* Centers the image */
                    background-repeat: no-repeat; /* Prevents image repetition */
                    width: 210mm;
    ...
    function selectConsignee(){
      ...
      if(document.getElementById('consignee').value==''){
        document.getElementById('consignee').value = selectedOption;
          ...
          // xhr.open('POST', './backend/get_customer_vat.php', true);
          //
          // // Set up headers
