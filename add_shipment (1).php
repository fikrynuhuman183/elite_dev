                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input list="dropdown-vehicle_num1" class="form-control eq-number" name="vehicle_num" id="vehicle_num1">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3">
                                  <button type="button" class="btn btn-danger form-control" onclick="addDropdownData()">Print Invoice</button>
                              </div>
      ...
      let printContent = `
            ...
            <head>
                <style>
                    ...
                    background-image: url('./dist/img/invoice.jpg');
            ...
            <body>
                <div class="invoice">
                    <div class="header">
                        <img style="width: 50%;" src="./dist/img/logo_ori4.jpg">
                        <h3> Tax Invoice</h3>
                    </div>
                    ...
                    <div class="section" >
                        ...
                        <div style="width:25%;"  class=" special-2">
                            <p style="color:red;">: 104311454300001</p>
                            <p>: ${vat_number}</p>
                    ...
                    let vehicleData = {}; // Object to hold vehicle types and their corresponding numbers
                      ...
                      printContent += `
                              ...
                              <div class="section">
                                  ...
                                  <div class="column">
                                    <p>: ELITE LINK LOGISTICS LLC</p>
                                    <p>: AE040030013580652920001</p>
                                    <p>: 13580652920001</p>
                                    <p>: ADCBAEAAXXX</p>
                                    <p>: ABU DHABI COMMERCIAL BANK</p>
                                    <p>: 251 / AL RIGGAH ROAD</p>
                                    <p>: AE040030013580652920001</p>
                                  </div>
                              ...
                              <div class="section">
                                <p>The payment cheque should be made payable to Elite Link Logistics LLC and should be crossed.</p>
                                ...
                                <div class="section">
                                  ...
                                  <div class="column">
                                    <p>: +971 542792941</p>
                                    <p>: Accounts@elitelinklogistics.com</p>
                                    <p>: P1/Block 1 , Dubai Industrial City , P.O Box 33653 , Jabel Ali , Dubai , UAE</p>
                                  </div>
                                  <div class="clear"></div>
                                </div>

                                <p>THIS IS A COMPUTER GENERATED DOCUMENT AND DOES NOT REQUIRE SIGNATURE AND STAMP</p>
                              </div>
                          </div>
                      </body>
                      </html>
                  `;
            var img = new Image();
        img.src = "./dist/img/logo_ori4.jpg";
        img.onload = function() {
