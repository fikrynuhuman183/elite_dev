(function(root, factory) {
    ...
    var translate = function(countryElement){
        ...
        var dz_region=["Adrar_DZ","Ain Defla_DZ","Ain Temouchent_DZ","Alger_DZ","Annaba_DZ","Batna_DZ","Bechar_DZ","Bejaia_DZ","Biskra_DZ","Blida_DZ","Bordj Bou Arreridj_DZ","Bouira_DZ","Boumerdes_DZ","Chlef_DZ","Constantine_DZ","Djanet_DZ","Djelfa_DZ","El Bayadh_DZ","El Meghaier_DZ","El Oued_DZ","El Tarf_DZ","Ghardaia_DZ","Guelma_DZ","Illizi_DZ","In Salah_DZ","Jijel_DZ","Khenchela_DZ","Laghouat_DZ","M'sila_DZ","Mascara_DZ","Medea_DZ","Mila_DZ","Mostaganem_DZ","Naama_DZ","Oran_DZ","Ouargla_DZ","Ouled Djellal_DZ","Oum el Bouaghi_DZ","Relizane_DZ","Saida_DZ","Setif_DZ","Sidi Bel Abbes_DZ","Skikda_DZ","Souk Ahras_DZ","Tamanrasset_DZ","Tebessa_DZ","Tiaret_DZ","Timimoun_DZ","Tindouf_DZ","Tipaza_DZ","Tissemsilt_DZ","Tizi Ouzou_DZ","Tlemcen_DZ","Touggourt_DZ"];
        ...
        var et_region=["Addis Ababa_ET","Afar_ET","Amara_ET","Benshangul-Gumaz_ET","Dire Dawa_ET","Gambela Peoples_ET","Harari People_ET","Oromia_ET","Sidama_ET","Somali_ET","Southern Nations, Nationalities and Peoples_ET","Southwest Ethiopia Peoples_ET","Tigrai_ET"];
        ...
        var id_region=["Aceh_ID","Bali_ID","Banten_ID","Bengkulu_ID","Gorontalo_ID","Jakarta Raya_ID","Jambi_ID","Jawa Barat_ID","Jawa Tengah_ID","Jawa Timur_ID","Kalimantan Barat_ID","Kalimantan Selatan_ID","Kalimantan Tengah_ID","Kalimantan Timur_ID","Kalimantan Utara_ID","Kepulauan Bangka Belitung_ID","Kepulauan Riau_ID","Lampung_ID","Maluku_ID","Maluku Utara_ID","Nusa Tenggara Barat_ID","Nusa Tenggara Timur_ID","Papua_ID","Papua Barat_ID","Papua Barat Daya_ID","Papua Pengunungan_ID","Papua Selatan_ID","Papua Tengah_ID","Riau_ID","Sulawesi Barat_ID","Sulawesi Selatan_ID","Sulawesi Tengah_ID","Sulawesi Tenggara_ID","Sulawesi Utara_ID","Sumatera Barat_ID","Sumatera Selatan_ID","Sumatera Utara_ID","Yogyakarta_ID"];
        ...
        var in1_region=["Andaman and Nicobar Islands_IN","Andhra Pradesh_IN","Arunachal Pradesh_IN","Assam_IN","Bihar_IN","Chandigarh_IN","Chhattisgarh_IN","Daman and Diu_IN","Delhi_IN","Goa_IN","Gujarat_IN","Haryana_IN","Himachal Pradesh_IN","Jammu and Kashmir_IN","Jharkhand_IN","Karnataka_IN","Kerala_IN","Lakshadweep_IN","Madhya Pradesh_IN","Maharashtra_IN","Manipur_IN","Meghalaya_IN","Mizoram_IN","Nagaland_IN","Odisha_IN","Puducherry_IN","Punjab_IN","Rajasthan_IN","Sikkim_IN","Tamil Nadu_IN","Telangana_IN","Tripura_IN","Uttar Pradesh_IN","Uttarakhand_IN","West Bengal_IN"];
        ...
        var kz_region=["Abay oblysy_KZ","Almaty_KZ","Almaty oblysy_KZ","Aqmola oblysy_KZ","Aqtobe oblysy_KZ","Astana_KZ","Atyrau oblysy_KZ","Batys Qazaqstan oblysy_KZ","Mangghystau oblysy_KZ","Pavlodar oblysy_KZ","Qaraghandy oblysy_KZ","Qostanay oblysy_KZ","Qyzylorda oblysy_KZ","Shyghys Qazaqstan oblysy_KZ","Soltustik Qazaqstan oblysy_KZ","Turkistan oblysy_KZ","Ulytau oblysy_KZ","Zhambyl oblysy_KZ","Zhetisu oblysy_KZ"];
        ...
        var me_region=["Andrijevica_ME","Bar_ME","Berane_ME","Bijelo Polje_ME","Budva_ME","Cetinje_ME","Danilovgrad_ME","Herceg-Novi_ME","Kolasin_ME","Kotor_ME","Mojkovac_ME","Niksic_ME","Plav_ME","Pljevlja_ME","Pluzine_ME","Podgorica_ME","Rozaje_ME","Savnik_ME","Tivat_ME","Ulcinj_ME","Zabljak_ME","Zeta_ME"];
        ...
        var np_region=["Bagmati_NP","Gandaki_NP","Karnali_NP","Koshi_NP","Lumbini_NP","Madhesh_NP","Sudurpashchim_NP"];
