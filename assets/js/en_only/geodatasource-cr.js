...
<div class="menu">' + countries + '</div>');
    ...
    var translate = function(countryElement){
        ...
        var ke_country=get.gettext("Kenya");var kg_country=get.gettext("Kyrgyzstan");var kh_country=get.gettext("Cambodia");var ki_country=get.gettext("Kiribati");var km_country=get.gettext("Comoros");var kn_country=get.gettext("Saint Kitts and Nevis");var kp_country=get.gettext("Korea (the Democratic People's Republic of)");var kr_country=get.gettext("Korea (the Republic of)");var kw_country=get.gettext("Kuwait");var ky_country=get.gettext("Cayman Islands");var kz_country=get.gettext("Kazakhstan");
        ...
        var tc_country=get.gettext("Turks and Caicos Islands");var td_country=get.gettext("Chad");var tf_country=get.gettext("French Southern Territories");var tg_country=get.gettext("Togo");var th_country=get.gettext("Thailand");var tj_country=get.gettext("Tajikistan");var tk_country=get.gettext("Tokelau");var tl_country=get.gettext("Timor-Leste");var tm_country=get.gettext("Turkmenistan");var tn_country=get.gettext("Tunisia");var to_country=get.gettext("Tonga");var tr_country=get.gettext("Turkiye");var tt_country=get.gettext("Trinidad and Tobago");var tv_country=get.gettext("Tuvalu");var tw_country=get.gettext("Taiwan (Province of China)");var tz_country=get.gettext("Tanzania, the United Republic of");
        ...
        var dz_region=["Adrar","Ain Defla","Ain Temouchent","Alger","Annaba","Batna","Bechar","Bejaia","Biskra","Blida","Bordj Bou Arreridj","Bouira","Boumerdes","Chlef","Constantine","Djanet","Djelfa","El Bayadh","El Meghaier","El Oued","El Tarf","Ghardaia","Guelma","Illizi","In Salah","Jijel","Khenchela","Laghouat","M'sila","Mascara","Medea","Mila","Mostaganem","Naama","Oran","Ouargla","Ouled Djellal","Oum el Bouaghi","Relizane","Saida","Setif","Sidi Bel Abbes","Skikda","Souk Ahras","Tamanrasset","Tebessa","Tiaret","Timimoun","Tindouf","Tipaza","Tissemsilt","Tizi Ouzou","Tlemcen","Touggourt"];
        ...
        var et_region=["Addis Ababa","Afar","Amara","Benshangul-Gumaz","Dire Dawa","Gambela Peoples","Harari People","Oromia","Sidama","Somali","Southern Nations, Nationalities and Peoples","Southwest Ethiopia Peoples","Tigrai"];
        ...
        var in1_region=["Andaman and Nicobar Islands","Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chandigarh","Chhattisgarh","Daman and Diu","Delhi","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka","Kerala","Lakshadweep","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Puducherry","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana","Tripura","Uttar Pradesh","Uttarakhand","West Bengal"];
        ...
        var kr_region=["Busan-gwangyeoksi","Chungcheongbuk-do","Chungcheongnam-do","Daegu-gwangyeoksi","Daejeon-gwangyeoksi","Gangwon-teukbyeoljachido","Gwangju-gwangyeoksi","Gyeonggi-do","Gyeongsangbuk-do","Gyeongsangnam-do","Incheon-gwangyeoksi","Jeju-teukbyeoljachido","Jeollabuk-do","Jeollanam-do","Sejong","Seoul-teukbyeolsi","Ulsan-gwangyeoksi"];
        var kw_region=["Al 'Asimah","Al Ahmadi","Al Farwaniyah","Al Jahra'","Hawalli","Mubarak al Kabir"];
        var ky_region=["Cayman Islands"];
        var kz_region=["Abay oblysy","Almaty","Almaty oblysy","Aqmola oblysy","Aqtobe oblysy","Astana","Atyrau oblysy","Batys Qazaqstan oblysy","Mangghystau oblysy","Pavlodar oblysy","Qaraghandy oblysy","Qostanay oblysy","Qyzylorda oblysy","Shyghys Qazaqstan oblysy","Soltustik Qazaqstan oblysy","Turkistan oblysy","Ulytau oblysy","Zhambyl oblysy","Zhetisu oblysy"];
        ...
        var me_region=["Andrijevica","Bar","Berane","Bijelo Polje","Budva","Cetinje","Danilovgrad","Herceg-Novi","Kolasin","Kotor","Mojkovac","Niksic","Plav","Pljevlja","Pluzine","Podgorica","Rozaje","Savnik","Tivat","Ulcinj","Zabljak","Zeta"];
        ...
        var np_region=["Bagmati","Gandaki","Karnali","Koshi","Lumbini","Madhesh","Sudurpashchim"];
        var nr_region=["Aiwo","Anabar","Anetan","Anibare","Baitsi","Buada","Ewa","Ijuw","Uaboe","Yaren"];
        var nu_region=["Niue"];
        var nz_region=["Auckland","Bay of Plenty","Canterbury","Chatham Islands Territory","Gisborne","Greater Wellington","Hawke's Bay","Manawatu-Whanganui","Marlborough","Nelson","Northland","Otago","Southland","Taranaki","Tasman","Waikato","West Coast"];
        ...
        var ph_region=["Abra","Agusan del Norte","Agusan del Sur","Aklan","Albay","Antique","Apayao","Aurora","Basilan","Bataan","Batanes","Batangas","Benguet","Biliran","Bohol","Bukidnon","Bulacan","Cagayan","Camarines Norte","Camarines Sur","Camiguin","Capiz","Catanduanes","Cavite","Cebu","Compostela Valley","Cotabato","Davao del Norte","Davao del Sur","Davao Oriental","Dinagat Islands","Eastern Samar","Guimaras","Ifugao","Ilocos Norte","Ilocos Sur","Iloilo","Isabela","Kalinga","La Union","Laguna","Lanao del Norte","Lanao del Sur","Leyte","Maguindanao del Norte","Maguindanao del Sur","Marinduque","Masbate","Mindoro Occidental","Mindoro Oriental","Misamis Occidental","Misamis Oriental","Mountain Province","National Capital Region","Negros Occidental","Negros Oriental","Northern Samar","Nueva Ecija","Nueva Vizcaya","Palawan","Pampanga","Pangasinan","Quezon","Quirino","Rizal","Romblon","Samar","Sarangani","Siquijor","Sorsogon","South Cotabato","Southern Leyte","Sultan Kudarat","Sulu","Surigao del Norte","Surigao del Sur","Tarlac","Tawi-Tawi","Zambales","Zamboanga del Norte","Zamboanga del Sur","Zamboanga Sibugay"];
